...
/*
    ...
    private static Method match(String methodName,
                                Class<?>[] paramValueTypes, Method[] methods) {
        Method finalMethod = null;
        ...
        for (Method m : methods) {
            ...
            if (name.equals(methodName)) {
                ...
                if (methodParamTypes != null && paramValueTypes != null) {
                    ...
                    finalMethod = m;
                    break;
                } else if (ArrayUtils.isEmpty(methodParamTypes)
                        && ArrayUtils.isEmpty(paramValueTypes)) {
